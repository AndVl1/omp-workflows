...
- [ ] 6.2 Обновить status/report readers для child progress, readiness, blocked dependencies, decision delivery/application и evidence; проверка: пользователь различает ожидание человека, рабочую итерацию и infra failure.
...
- [ ] 7.1 Выполнить live bug journey с неуспешной первой проверкой и повторным fix-cycle; проверка: lead завершает цикл и evidence без внутренних dispatch со стороны CTO.
