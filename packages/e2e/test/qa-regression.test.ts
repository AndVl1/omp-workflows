...
function writeFixtureSession(dir: string, taskPrompt: string): void {
  ...
  writeFileSync(
    ...
    JSON.stringify({
      ...
      browser_url: 'http://127.0.0.1:52464/?code=fake',
      token: 'fake',
      control_nonce: 'fixture-control-nonce',
      pid: 58326,
      pty_start_identity: 'fixture-pty-start',
      server_start_nonce: 'fixture-server-start',
      server_pid: 58326,
      server_start_identity: 'fixture-server-identity',
      started_at: '2026-08-02T12:00:00.000Z',
      shutdown_completed_at: '2026-08-02T12:00:05.000Z',
      stopped_at: '2026-08-02T12:00:05.000Z',
      finished_at: '2026-08-02T12:00:05.000Z',
      shutdown_error: null,
