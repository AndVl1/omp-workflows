...
## [0.22.3] — 2026-08-17
### Fixed
- **Canonical workflow session cwd** — workflow commands and tools now resolve the project root through OMP's session manager, preventing stale branch/state rejection after session resume or worktree switches.
